...
class GarminClient(object):
    ...
    def list_activities(self):
        ...
        # will only get up to maxint activities...
        for start_index in range(0, maxint, batch_size):
    ...
    def _fetch_activity_ids_and_ts(self, start_index, max_limit=100):
        ...
        for activity in activities:
            ...
            timestamp_local = timestamp_utc.astimezone(dateutil.tz.tzlocal())

            entries.append( (id, timestamp_local))
